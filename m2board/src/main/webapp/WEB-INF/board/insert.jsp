...
<body>
	<form name="myform" action="BoardInsertAction.do" method="post">
		<table>
			...
			<tr>
				<th>제목</th>
				<td><input type="text" name="title" style="width:645px;" maxlength="200" autofocus="autofocus" required="required"/></td>
			</tr>
			
			<tr>
				<th>내용</th>
				<td>
					<textarea rows="5" style="width:645px;" name="content" id="content" required="required">
					</textarea>
					<script type="text/javascript">
						var oEditors = [];
